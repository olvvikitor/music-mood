                ...
                >
                    ...
                    <div className="relative px-5 pt-6 pb-5 flex gap-4 items-start">
                        ...
                        <div className="relative shrink-0 w-20 h-20 rounded-2xl overflow-hidden"
                            style={{ border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 8px 32px rgba(0,0,0,0.6)" }}>
                        ...
                        <div className="px-5 pb-4 flex flex-col gap-2.5">
                            ...
                            <div className="px-4 py-3 rounded-xl"
                                style={{
                                    ...
                                    borderLeft: "2px solid rgba(255,45,135,0.35)",
                    ...
                    <div className="px-5 py-4 grid grid-cols-3 gap-2">
                        {[
                            { label: "Score", value: `${Math.round(track.moodScore * 100)}%`, accent: "#00ffb3" },
                            { label: "Polaridade", value: track.coreAxes.polaridade > 0 ? "Positivo" : "Negativo", accent: track.coreAxes.polaridade > 0 ? "#00ffb3" : "#ff2d87" },
                            { label: "Quadrante", value: track.coreAxes.quadrante.replace("Negativo", "Neg.").replace("Positivo", "Pos."), accent: "#a259ff" },
                        ].map(item => (
